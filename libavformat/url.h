...
typedef struct URLContext {
	...
	//AVIO_FLAG_READ 对http为get,AVIO_FLAG_WRITE为post
    int flags;				//AVIO_FLAG_READ、AVIO_FLAG_WRITE、AVIO_FLAG_READ_WRITE
    int max_packet_size;        /**< if non zero, the stream is packetized with this max packet size */
    int is_streamed;            /**< true if streamed (no seek possible), default = false ;本地文件为0,,http等为1 */
    int is_connected;
